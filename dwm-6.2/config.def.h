...
static const char *fonts[]          = { "robotomono:size=12", "JoyPixels:pixelsize=16", "siji:pixelsize=18", "fontAwesome:size=14" };
...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_blu, col_gray0,  col_gray1  },
    [SchemeTitle]  = { col_blu, col_gray0, col_gray2  },
};
